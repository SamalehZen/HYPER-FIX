    ...
    try:
        ...
        with open(sql_file, 'w', encoding='utf-8') as f:
            ...
            for item in items:
                ...
                f.write(f"INSERT INTO cyrus_structure (level, code, name, parent_code, full_path) VALUES ({item['level']}, '{item['code']}', '{item['name'].replace(\"'\", \"''\")}', {parent_code}, '{item['full_path'].replace(\"'\", \"''\")}');\n")
