...
// --- TimelineItem and RadialOrbitalTimeline components ---
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-20 h-20 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10 shadow-lg shadow-blue-500/50">
            ...
            ></div>
            <div
              className="absolute w-32 h-32 rounded-full border border-white/5 animate-ping opacity-30"
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute rounded-full -inset-1 ${isPulsing ? "animate-pulse duration-1000" : ""} ${isRelated ? "bg-gradient-to-br from-blue-400 to-purple-400 opacity-30" : ""}`}
                  style={{
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ...
                      : isRelated
                      ? "bg-white/50 text-black border-white animate-pulse-fast"
                      : "bg-black text-white"
                  }
                  border-2
                  ${
